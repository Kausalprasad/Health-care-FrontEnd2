...
const ProfileSetupStep3 = ({ navigation }) => {
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      const response = await fetch(`${BASE_URL}/api/profile/step3`, {
        method: 'POST',
        headers: {
  ...
  const handleSkip = () => {
    Alert.alert(
      ...
      [
        ...
        { text: 'Skip', onPress: () => navigation.navigate('ProfileViewScreen') }
      ]
    );
  };
  ...
  return (
    ...
    onPress={() => {
      ...
      // OR navigation.navigate("ProfileViewScreen");
    }}
  >
...
const styles = StyleSheet.create({
  ...
  progressFilled: {
    width: '100%', // Full progress for step 3
    height: '100%',
